	...
	<head>
		...
		if(isset($_POST['search']))
		{
			...
			if(isset($_POST['options']))
            {
			    ...
			    print("<table width=\"100%\" border =\"1\" style=\"color:black;\"><tr><th width=\"30%\" style = \"background-color: gray;\">Title</th><th width:\"40%\" style = \"background-color: gray;\">Author</th><th width:\"10%\" style = \"background-color: gray;\">Copies</th><th width:\"20%\" style = \"background-color: gray;\">ISBN</th></tr>");
